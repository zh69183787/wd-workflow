 ...
 * 
 */
package com.wonders.discipline.workflow.process.dept.action;
...
@Namespace(value="/discipline-deptSub")
@Controller("discipline-deptSubAction")
@Scope("prototype")
public class DeptSubAction extends AbstractParamAction implements ModelDriven<DeptSubVo>{
	...
	public void setService(@Qualifier("discipline-deptSubService")DeptSubService service) {
