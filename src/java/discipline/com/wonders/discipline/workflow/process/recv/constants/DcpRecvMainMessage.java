...
public class DcpRecvMainMessage {
	...
	public static final MessageBo CHECK_NO_TITLE = new MessageBo("文件标题不为空！","title",error2);
	...
	public static final MessageBo CHECK_KEYWORD_LIMIT_50 = new MessageBo("关键字应小于50字！","keyword",error2);
	public static final MessageBo CHECK_TITLE_LIMIT_100 = new MessageBo("文件标题应小于100字！","title",error2);
	public static final MessageBo CHECK_FILE_NUM_50 = new MessageBo("文件字号应小于50字！","filezh",error2);
	...
	public static final MessageBo CHECK_RECV_SAME_DOC = new MessageBo("您提交的文件重复，请检查！","filezh",error2);
	public static final MessageBo CHECK_NO_COM_LEADER = new MessageBo("请选择集团领导！","comLeaderName",error2);
	public static final MessageBo CHECK_NO_DCP = new MessageBo("请选择纪委委员！","dcpName",error2);
	public static final MessageBo CHECK_NO_DEPT = new MessageBo("请选择处理部门！","filezh",error2);
	public static final MessageBo CHECK_NO_SIMULATER = new MessageBo("请选择拟办领导！","simulateLoginName",error2);
	public static final MessageBo CHECK_NO_FINISHER = new MessageBo("请选择办结人员！","finishLoginName",error2);
