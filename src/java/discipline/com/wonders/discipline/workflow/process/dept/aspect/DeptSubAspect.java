package com.wonders.discipline.workflow.process.dept.aspect;
...
import com.wonders.discipline.workflow.process.dept.service.DeptSubCheckService;
import com.wonders.discipline.workflow.process.dept.service.DeptSubService;

@Aspect
@Component("discipline-deptSubAspect")
public class DeptSubAspect {
	 ...
	 * @throws Throwable
	 */
	@Before(value="execution(public * com.wonders.discipline.workflow.process.dept.service.DeptSubService.flowStep*(..))")
...
//log.debug("check:"+stepCode);
	...
	@Autowired
	public void setCheckService(@Qualifier("discipline-deptSubCheckService")DeptSubCheckService checkService) {
