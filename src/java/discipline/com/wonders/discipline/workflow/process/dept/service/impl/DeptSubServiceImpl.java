...
import com.wonders.discipline.workflow.process.dept.constants.DeptSubMessage;
...
@Service("discipline-deptSubService")
@Scope("prototype")
...
//log.debug("flowLeaderDeal");
	...
	public void setDeptSubApprovedService(
			@Qualifier(value="discipline-deptSubApprovedService")DeptSubApprovedService deptSubApprovedService) {
