 ...
 * 
 */
package com.wonders.discipline.workflow.approve.action;
...
import com.wonders.discipline.workflow.approve.service.ApprovedInfoService;
...
@Namespace(value="/discipline-approve")
@Controller("discipline-approvedInfoAction")
@Scope("prototype")
public class ApprovedInfoAction extends AbstractParamAction{
	...
	@Action(value="approve",results={
			@Result(name="success",location="/discipline/approve/approve.jsp")
	})
	...
	@Action(value="dept",results={
			@Result(name="success",location="/discipline/approve/dept.jsp")
	})
	public String dept(){
...
/**
	...
	public void setService(@Qualifier("discipline-approvedInfoService")ApprovedInfoService service) {
