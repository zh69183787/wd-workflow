package com.wonders.discipline.workflow.external.util;
...
import com.wonders.discipline.workflow.common.util.CommonUtil;
import com.wonders.discipline.workflow.common.util.SimpleLogger;
import com.wonders.discipline.workflow.external.constant.ExternalConstants;
import com.wonders.discipline.workflow.external.model.AbstractExternalResult;
import com.wonders.discipline.workflow.external.model.ExternalResultMulti;
import com.wonders.discipline.workflow.external.model.ExternalResultSingle;
...
//	
	...
	* @Description: 得到指定群组信息(这里用一句话描述这个方法的作用) 
	* @param @param code
	* @param @return    设定文件 
	* @return String    返回类型 
	* @throws 
	*/
	public String getGroupUsersInfo(String code){
		return service(ExternalConstants.METHOD_GET_GROUP_USERS_INFO,wrapForTag(code,"code"));
	}
	...
	* @throws 
	*/
	public String getGroupsInfo(String code){
		return service(ExternalConstants.METHOD_GET_GROUS_INFO,wrapForTag(code,"code"));
	}
