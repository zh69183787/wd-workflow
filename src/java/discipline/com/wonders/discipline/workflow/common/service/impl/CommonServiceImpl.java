package com.wonders.discipline.workflow.common.service.impl;
...
import com.wonders.discipline.workflow.common.dao.CommonDao;
import com.wonders.discipline.workflow.common.service.CommonService;


@Transactional(propagation=Propagation.REQUIRED,rollbackFor=Exception.class)
@Repository("discipline-commonService")
@Scope("prototype")
public class CommonServiceImpl implements CommonService {
	...
	public void setDao(@Qualifier(value="discipline-commonDao")CommonDao dao) {
		this.dao = dao;
	}
}
