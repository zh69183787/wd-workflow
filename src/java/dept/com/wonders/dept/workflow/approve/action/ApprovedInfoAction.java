 ...
 * 
 */
package com.wonders.dept.workflow.approve.action;
...
import com.wonders.dept.workflow.approve.service.ApprovedInfoService;
...
@Namespace(value="/dept-approve")
@Controller("dept-approvedInfoAction")
@Scope("prototype")
public class ApprovedInfoAction extends AbstractParamAction{
	...
	@Action(value="approve",results={
			@Result(name="success",location="/dept/approve/approve.jsp")
	})
...
/**
	...
	public void setService(@Qualifier("dept-approvedInfoService")ApprovedInfoService service) {
