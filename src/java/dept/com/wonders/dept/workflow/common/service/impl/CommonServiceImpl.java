package com.wonders.dept.workflow.common.service.impl;
...
import com.wonders.dept.workflow.common.dao.CommonDao;
import com.wonders.dept.workflow.common.service.CommonService;


@Transactional(propagation=Propagation.REQUIRED,rollbackFor=Exception.class)
@Repository("dept-commonService")
@Scope("prototype")
public class CommonServiceImpl implements CommonService {
	...
	public void setDao(@Qualifier(value="dept-commonDao")CommonDao dao) {
		this.dao = dao;
	}
}
