package com.wonders.dept.workflow.util;
...
public class FlowUtil {
	...
	*/
	 ...
	 * 检查是否已签收
	 * */
	public static boolean checkExistData(String mainId,String loginName){
		String sql = "select * from t_dept_pass t where t.main_id = ? "
				+ " and t.reg_login_name = ? and t.removed= '0'"; 
		Object[] params = new Object[]{mainId,loginName};	
		List<Map<String,Object>> list = dbUtil.getJdbcTemplate().queryForList(sql,params);
		if(list != null && list.size() > 0){
			return true;
		}
