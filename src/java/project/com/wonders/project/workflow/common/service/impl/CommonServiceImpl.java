package com.wonders.project.workflow.common.service.impl;
...
import com.wonders.project.workflow.common.dao.CommonDao;
import com.wonders.project.workflow.common.service.CommonService;


@Transactional(propagation=Propagation.REQUIRED,rollbackFor=Exception.class)
@Repository("project-commonService")
@Scope("prototype")
public class CommonServiceImpl implements CommonService {
	...
	public void setDao(@Qualifier(value="project-commonDao")CommonDao dao) {
		this.dao = dao;
	}
}
