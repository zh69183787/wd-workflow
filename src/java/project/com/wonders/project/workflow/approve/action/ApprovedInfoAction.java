 ...
 * 
 */
package com.wonders.project.workflow.approve.action;
...
@Namespace(value="/project-approve")
@Controller("project-approvedInfoAction")
@Scope("prototype")
public class ApprovedInfoAction extends AbstractParamAction{
	...
	@Action(value="approve",results={
			@Result(name="success",location="/project/approve/approve.jsp")
	})
	...
	@Action(value="dept",results={
			@Result(name="success",location="/project/approve/dept.jsp")
	})
	public String dept(){
...
/**
	...
	public void setService(@Qualifier("project-approvedInfoService")ApprovedInfoService service) {
