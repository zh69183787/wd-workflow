package com.wonders.project.workflow.process.dept.aspect;
...
import com.wonders.project.workflow.process.dept.service.DeptSubService;

@Aspect
@Component("project-deptSubAspect")
public class DeptSubAspect {
	 ...
	 * @throws Throwable
	 */
	@Before(value="execution(public * com.wonders.project.workflow.process.dept.service.DeptSubService.flowStep*(..))")
...
//log.debug("check:"+stepCode);
	...
	@Autowired
	public void setCheckService(@Qualifier("project-deptSubCheckService")DeptSubCheckService checkService) {
