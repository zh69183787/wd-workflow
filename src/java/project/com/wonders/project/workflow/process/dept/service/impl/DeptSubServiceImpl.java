...
import com.wonders.project.workflow.process.dept.constants.DeptSubStepConstants;
...
import com.wonders.project.workflow.process.dept.service.DeptSubApprovedService;
...
@Service("project-deptSubService")
@Scope("prototype")
...
//log.debug("flowLeaderDeal");
	...
	public void setDeptSubApprovedService(
			@Qualifier(value="project-deptSubApprovedService")DeptSubApprovedService deptSubApprovedService) {
