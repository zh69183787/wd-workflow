 ...
 * 
 */
package com.wonders.project.workflow.process.dept.action;
...
@Namespace(value="/project-deptSub")
@Controller("project-deptSubAction")
@Scope("prototype")
public class DeptSubAction extends AbstractParamAction implements ModelDriven<DeptSubVo>{
	...
	public void setService(@Qualifier("project-deptSubService")DeptSubService service) {
