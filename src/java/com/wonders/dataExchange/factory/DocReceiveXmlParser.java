...
import com.wonders.dataExchange.model.flow.xml.RecvMainXml;
...
public class DocReceiveXmlParser implements XmlParser{
	...
	*/
	...
	public void parse(MainParamVo params, DwWorkflowInterface bo) {
		...
		RecvMainXml xml = (RecvMainXml) DataExchangeUtil.parseXml(content,RecvMainXml.class);
		RecvMainVo mainVo = xml.getMainVo();
