package com.wonders.contract.workflow.common.service.impl;
...
import com.wonders.contract.workflow.common.dao.CommonDao;
import com.wonders.contract.workflow.common.service.CommonService;


@Transactional(propagation=Propagation.REQUIRED,rollbackFor=Exception.class)
@Repository("contract-commonService")
@Scope("prototype")
public class CommonServiceImpl implements CommonService {
	...
	public void setDao(@Qualifier(value="contract-commonDao")CommonDao dao) {
		this.dao = dao;
	}
}
