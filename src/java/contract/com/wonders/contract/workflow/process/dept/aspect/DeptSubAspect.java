package com.wonders.contract.workflow.process.dept.aspect;
...
import com.wonders.contract.workflow.process.dept.service.DeptSubCheckService;
import com.wonders.contract.workflow.process.dept.service.DeptSubService;

@Aspect
@Component("contract-deptSubAspect")
public class DeptSubAspect {
	 ...
	 * @throws Throwable
	 */
	@Before(value="execution(public * com.wonders.contract.workflow.process.dept.service.DeptSubService.flowStep*(..))")
...
//log.debug("check:"+stepCode);
	...
	@Autowired
	public void setCheckService(@Qualifier("contract-deptSubCheckService")DeptSubCheckService checkService) {
