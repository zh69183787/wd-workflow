 ...
 * 
 */
package com.wonders.contract.workflow.process.review.model.vo;
...
public class ReviewMainVo {
	//结构化意见
	private String structuredSuggest;
	...
	public String getStructuredSuggest() {
		return structuredSuggest;
	}

	public void setStructuredSuggest(String structuredSuggest) {
		this.structuredSuggest = structuredSuggest;
	}
