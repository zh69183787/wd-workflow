 ...
 * 
 */
package com.wonders.contract.workflow.process.dept.action;
...
@Namespace(value="/contract-deptSub")
@Controller("contract-deptSubAction")
@Scope("prototype")
public class DeptSubAction extends AbstractParamAction implements ModelDriven<DeptSubVo>{
	...
	public void setService(@Qualifier("contract-deptSubService")DeptSubService service) {
