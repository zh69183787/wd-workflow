package com.wonders.contract.workflow.external.service.impl;
...
import com.wonders.contract.workflow.external.util.PortalUtil;
 ...
 */
@Service("contract-externalService")
@Scope("prototype")
