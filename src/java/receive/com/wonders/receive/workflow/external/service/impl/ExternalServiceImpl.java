package com.wonders.receive.workflow.external.service.impl;
...
import com.wonders.receive.workflow.external.util.PortalUtil;
import com.wonders.receive.workflow.organTree.model.bo.OrganDeptBo;
import com.wonders.receive.workflow.organTree.model.bo.OrganLeaderBo;
 ...
 */
@Service("receive-externalService")
@Scope("prototype")
public class ExternalServiceImpl implements ExternalService {
	...
	public Map<String,String> getDeptReceiversMap(String processName,String stepName,String deptIdStr) {
		...
		List<OrganUserBo> list = this.getReceivers(processName,stepName,deptIdStr);
