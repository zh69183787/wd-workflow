...
public class TextUtil {
	...
	*/
	...
	public static String generateMainUrl(String pname,String pincident,String cname,String cincident,String Steplabel){
		String type = "";
		if(UltimusConstants.RECV_DICTIONARY_NAME.equals(pname)){
			type = "receive-recvMain";
		}else if(UltimusConstants.REDV_DICTIONARY_NAME.equals(pname)){
			type = "receive-redvMain";
		}
		String url = 
				"/"+type+"/forward.action?"
