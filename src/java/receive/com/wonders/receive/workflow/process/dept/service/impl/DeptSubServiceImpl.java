...
import com.wonders.receive.workflow.process.dept.constants.DeptSubStepConstants;
...
import com.wonders.receive.workflow.process.dept.service.DeptSubApprovedService;
...
@Service("receive-deptSubService")
@Scope("prototype")
...
//log.debug("flowLeaderDeal");
	...
	public void setDeptSubApprovedService(
			@Qualifier(value="receive-deptSubApprovedService")DeptSubApprovedService deptSubApprovedService) {
