package com.wonders.receive.workflow.process.instruct.aspect;
...
@Aspect
@Component("receive-instructSubAspect")
public class InstructSubAspect {
	private InstructSubCheckService checkService;
	 ...
	 * @throws Throwable
	 */
	@Before(value="execution(public * com.wonders.receive.workflow.process.instruct.service.InstructSubService.flowStep*(..))")
	...
	private void initService(JoinPoint joinPoint){
		...
		InstructSubService target = (InstructSubService) joinPoint.getTarget();
		InstructSubParamVo params = (InstructSubParamVo) args[0];
...
//log.debug("check:"+stepCode);
	...
	public InstructSubCheckService getCheckService() {
		return checkService;
	}
	
	@Autowired
	public void setCheckService(@Qualifier("receive-instructSubCheckService")InstructSubCheckService checkService) {
