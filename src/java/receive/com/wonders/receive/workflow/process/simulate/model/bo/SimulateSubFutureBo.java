 ...
 * 
 */
package com.wonders.receive.workflow.process.simulate.model.bo;
...
public class SimulateSubFutureBo implements Serializable{
	...
	@Column(name = "INSINSLDSID", nullable = true, length = 500)
	...
	@Column(name = "INSINSLDSDEPID", nullable = true, length = 500)
	...
	@Column(name = "INSINSSECSID", nullable = true, length = 500)
	...
	@Column(name = "INSINSSECSDEPID", nullable = true, length = 500)
	...
	@Column(name = "SUGDEPLDSID", nullable = true, length = 500)
	...
	@Column(name = "SUGDEPLDSDEPID", nullable = true, length = 500)
	...
	@Column(name = "SIGNLDSID", nullable = true, length = 500)
	...
	@Column(name = "SIGNLDSDEPID", nullable = true, length = 500)
	...
	@Column(name = "SIGNSECSID", nullable = true, length = 500)
	...
	@Column(name = "SIGNSECSDEPID", nullable = true, length = 500)
	...
	@Column(name = "CHKLDSID", nullable = true, length = 500)
	...
	@Column(name = "CHKLDSDEPID", nullable = true, length = 500)
	...
	@Column(name = "CHKSECSID", nullable = true, length = 500)
	...
	@Column(name = "CHKSECSDEPID", nullable = true, length = 500)
	...
	@Column(name = "MAINDEPID", nullable = true, length = 500)
	...
	@Column(name = "MAINDEPRECVID", nullable = true, length = 500)
	...
	@Column(name = "MAINDEPLDID", nullable = true, length = 500)
	...
	@Column(name = "FINPERSONID", nullable = true, length = 500)
	...
	@Column(name = "FINPERSONDEPID", nullable = true, length = 500)
