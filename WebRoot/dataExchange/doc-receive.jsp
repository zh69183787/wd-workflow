        ...
        <div class="gray_bg">
        	<div class="gray_bg2">
            	<div class="w_bg">
                	<div class="Bottom">
                    	<div class="Top">
                        	<h1 class="t_c"><b style="display:inline;">${sessionScope.dept_name}</b><br><b>送文处理单</b></h1>
                        	
							<div class="mb10">
	                            <input type="hidden" name="steplabel" value="<%=RecvMainStepConstants.STEPNAME_REGISTER%>"/>
								<input type="hidden" name="chiefPerson" value="${params.vo['chiefPerson']}"/>
								<input type="hidden" id="taskuser" name="taskuser" value="${params.registerVo.loginName}"/>
								<input type="hidden" id="taskDeptId" name="taskDeptId" value="${params.registerVo.deptId}"/>
								<input type="hidden" id="mainId" name="mainId" value="${params.id}"/>
								...
								<table id="form_detail_zone" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                  	...
                                  	<tr class="content6">
	                                    ...
	                                    <input name="title" type="text" class="input_large" id="title" style="width:90%;"  value="${params.vo['title']}"/>
									...
									<tr class="content7">
	                            	    ...
	                            	    <font class="redMark">*&nbsp;</font>
	                            	    <input type="hidden" id="t_chiefDep" name="t_chiefDep" value="${params.vo['chiefDep']}">                          	    
	                            	    <input type="hidden" name="swId" id="swId" value="${params.vo['swId']}">
	                            	     <td colspan="1" class="lableTd t_v">文件日期：</td>
	                            	    <td colspan="1"><input type="text" class="input_large date" name="fileDate" id="fileDate" readonly="readonly"  value="${params.vo['fileDate'] }"/>
	                            	    <font class="redMark">*&nbsp;</font>
	                            	    </td>
	                          	    </tr>
									...
									<tr class="content7">
	                            	    ...
	                            	    <td colspan="1"><input type="text" class="input_large" name="swUnit" id="swUnit" value="${params.vo['swUnit']}"/>
	                            	    <input type="button" value="选择" name="swUnitSel" id="swUnitSel"/>
	                            	    <font class="redMark">*&nbsp;</font>
	                            	    </td>
	                                    <td colspan="1" class="lableTd t_v">文件字号：</td>
	                            	    <td colspan="1"><input type="text" class="input_large" name="filezh" id="filezh" value="${params.vo['filezh']}"/>
	                            	    <font class="redMark">*&nbsp;</font>
	                            	    </td>
	                          	 	</tr>
	                          	    ...
	                          	    <tr class="content6">
	                                    ...
	                                    <input name="keyword" type="text" class="input_large" id="keyword" style="width:100%;"  value="${params.vo['keyword']}"/></td>
                                  	</tr>
                                  	...
                                  	<tr class="content7">
	                                    ...
	                                    <td colspan="3">
	                                    	<input type="hidden" name="attach" id='attach' value="${params.vo['attach'] }"/>
										  	<%-- --%>
										  	...
										  	src="<%=path %>/attach/loadFileList.action?fileGroup=attach&fileGroupName=attachGroup&fileGroupId=${params.vo['attach']}&userName=${params.userInfo.userName}&loginName=${params.userInfo.login_Name}&procType=edit&targetType=frame&type=1"></iframe>
										</td>
	                          	    </tr>
									...
									<tr class="content7">
										...
										<textarea id="remark" name="remark" rows="10" >${params.vo['remark']}</textarea>
										</td>	
	                            	</tr>
	                          	    ...
	                          	    <tr class="content7">
	                            	    ...
	                            	    <font class="redMark">*&nbsp;</font>
	                            	    <input type="hidden" id="t_blMode" name="t_blMode" value="${params.vo['blMode']}">
	                            	    </td>
	                               </tr>
	                          	   <tr class="content7">
