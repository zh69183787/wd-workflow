...
<head>
<meta charset="utf-8" />
	<link rel="stylesheet" href="<%=path %>/dept/organTree/css/demo.css" type="text/css">
	<link rel="stylesheet" href="<%=path %>/dept/organTree/css/zTreeStyle/zTreeStyle.css" type="text/css">
	<script type="text/javascript" src="<%=path %>/dept/organTree/js/jquery-1.4.4.min.js"></script>
	<script type="text/javascript" src="<%=path %>/dept/organTree/js/jquery.ztree.all-3.5.js"></script>
	...
	<script type="text/javascript">
		...
		var setting = {
			async: {
				enable: true,
				url:"<%=path %>/contract-organTree/getDeptUsers.action",
				autoParam:["id"],
				dataFilter: filter
			},
			check: {
				...
				$.getJSON(
					...
					function(json){
						if(json){
							json[0].nocheck=true;
							root = json[0].id;
							json[0].icon = "<%=path %>/dept/organTree/img/com.png";
							zNodes = json;
							initByZNodes();
						}
					}
