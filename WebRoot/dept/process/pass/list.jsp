...
<html>
  ...
  <body>
	...
	<%
		...
		List<Map<String,Object>> list = ProcessUtil.generateDeptQueryList();
	...
	//System.out.println(list.size());
		...
		out.println("<tr class='list-title'><td>主流程</td><td>主流程ID</td><td>标题</td><td>登记人</td><td>状态</td><td>查看</td><td>监控</td></tr>");
		...
		for(int i=0;i<list.size();i++){
			...
			out.print("<td>"+StringUtil.getNotNullValueString(map.get("reg_name"))+"</td>");
