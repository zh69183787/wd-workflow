		...
		<div style="width: 98%;">
			...
			<s:form theme="simple" action="upFileJsp" enctype="multipart/form-data" method="post" namespace="/attach">
				...
				<select name="attachMemo" id="attachMemo">
					<option value="合同及附件">合同及附件</option>
					<option value="后备案">后备案</option>
					<option value="合同会签单">合同会签单</option>
					<option value="实施依据">实施依据</option>
					<option value="价格依据">价格依据</option>
					<option value="采购或工程量清单">采购或工程量清单</option>
