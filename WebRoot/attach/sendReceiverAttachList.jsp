				...
				<table width="100%" cellpadding="2" cellspacing="0">
					...
					<tr>
						<td style="line-height: 15px">
							...
							<%if("pdf".equals(file.getFileExtName()) && file.getUploadDate().compareTo("2014-01-14 00:00:00")>=0){ %>
							<a href="<%=downloadUrl%>?fileId=<%=file.getAttachFile().getId()%>&codeId=<%=codeId %>" target="_blank"
