...
String filezh = "";
if("2921".equals(deptId)){
	filezh = "沪地铁运一司 （2014） 号";
}else if("2923".equals(deptId)){
	filezh = "沪地铁运三司 （2014） 号";
}else if("2924".equals(deptId)){
	filezh = "沪地铁运四司 （2014） 号";
}else if("2920".equals(deptId)){
	filezh = "沪地铁运管 （2014） 号";
}else if("2925".equals(deptId)){
	filezh = "沪地铁维保〔2014〕号";
}else if("2959".equals(deptId)){
	filezh = "沪申通桥〔2014〕号";
}else if("2945".equals(deptId)){
	filezh = "沪申铁〔2014〕号";
}else if("2943".equals(deptId)){
	filezh = "沪隧设院政 （2014） 号";
}else if("2941".equals(deptId)){
	filezh = "沪轨技〔2014〕号";
}else if("2922".equals(deptId)){
	filezh = "沪地铁运二司 （2014） 号";
}else if("2946".equals(deptId)){
	filezh = "沪申通资产〔2014〕号";
}else if("2944".equals(deptId)){
	filezh = "沪地铁培训〔2014〕号";
}else if("2962".equals(deptId)){
		    ...
		    success:function(obj){
		    	if(obj){
			    	if(obj.checkFlag){
						...
						window.location.href = contextpath+"/receive/process/recv/add_cross.jsp";
						//window.opener=null;
						//window.open("","_self");
						//window.close();
			    	}else{
        ...
        <div class="gray_bg">
        	<div class="gray_bg2">
            	<div class="w_bg">
                	<div class="Bottom">
                    	<div class="Top">
                        	<h1 class="t_c"><b style="display:inline;"><s:property value="#session.dept_name"/></b><br><b>发文稿纸</b></h1>
							...
							<div class="mb10">
								...
								<table id="form_detail_zone" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
									...
									<tr class="content7">
	                                    <td class="lableTd t_v">送文单位：</td>
	                            	    <td><input type="text" class="input_large" name="swUnit" id="swUnit" value='<s:property value="#session.dept_name"/>'/>
	                            	    <!-- <input type="button" value="选择" name="swUnitSel" id="swUnitSel"/> -->
	                            	    <font class="redMark">*&nbsp;</font>
	                            	    </td>
	                                    <td class="lableTd t_v">文件字号：</td>
	                            	    <td><input type="text" class="input_large" name="filezh" id="filezh" value='<%=filezh%>'/>
	                            	    <font class="redMark">*&nbsp;</font>
	                            	    </td>
	                          	    </tr>
