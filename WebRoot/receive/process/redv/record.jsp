...
$(function(){
	$("#handleSubmit").click(function(){
		if(confirm("确认提交吗？")){
			...
			options.url = "<%=path %>/receive-redvMain/record.action";
			<%}%>
				...
				<tr>
	  			<td colspan=2>
			  		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		              	...
		              	<tr>
		              		<td class="td_1">&nbsp;</td>
		                	<td><textarea id="suggest" name="suggest" rows="5"><%if(RedvMainStepConstants.STEPNAME_RECORD.equals(steplabel)){%>备案完成。<%} %></textarea></td>
		              	</tr>
	              	</table>
           		</td>
           	</tr>
