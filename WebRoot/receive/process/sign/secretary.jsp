...
$(function(){
	$("#handleSubmit").click(function(){
		...
		if(confirm("确认提交吗？")){
			...
			options.url = "<%=path %>/receive-signSub/secretaryDeal.action";
...
<div id="handle_zone" style="display:none;" title="会签领导秘书">
	<input type="hidden" id="type" name="type" value="0"/>			
	<div class="con"> 	
		<table id="choiceZone1" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr height="30">
				<td class="td_1">
					<input type="radio" checked="checked" name="choice" value="<%=SignSubConstants.CHOICE_SECRETARY_READ %>"/>
				</td>
				<td>已阅</td>
			</tr>
			<tr height="30">
				<td class="td_1">
					<input type="radio" name="choice" value="<%=SignSubConstants.CHOICE_SECRETARY_AGREE %>"/>
				</td>
				<td>同意</td>
			</tr>
	  		<tr height="30">
				<td class="td_1">
					<input type="radio" name="choice" value="<%=SignSubConstants.CHOICE_SECRETARY_OTHER_SUGGEST %>"/>
				</td>
				<td>其他意见（对收文流程或下级提出的意见有其他意见，请在备注中注明）</td>
			</tr>
			<tr height="30">
				<td class="td_1">
					<input type="radio" name="choice" value="<%=SignSubConstants.CHOICE_SECRETARY_BACK_OFFICE %>"/>
				</td>
