...
function selectDeptUser(zoneId){
	var url = contextpath+"/send/organTree/deptUserTree.jsp?zoneId="+zoneId+"&random="+Math.random();
	window.open(url);
}

function selectDeptLeader(zoneId){
	var url = contextpath+"/send/organTree/deptLeaderTree.jsp?zoneId="+zoneId+"&random="+Math.random();
	window.open(url);
}

function selectDeptLeaders(zoneId){
	var url = contextpath+"/send/organTree/deptLeaderTree.jsp?zoneId="+zoneId+"&chkStyle=checkbox&random="+Math.random();
	window.open(url);
}
