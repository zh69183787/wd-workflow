...
.ctrl .lit_nav li a, .totle, .panel_6 .icon, .panel_6 li a.print, .panel_6 li a.tips, .panel_6 li a.ywbl, .panel_6 li a.imp, .panel_6 li a.exp, .panel_6 li a.jk, .f_window .close, .node .dis, .node .fw, .filter .fn h5 a.colSelect
{
	background-image:url(images/icon_1.png);
}
...
aside hgroup h6, .news hgroup h6, .news .txt_list li span, .panel_3 .con li span, .panel_4 .con span, .panel_4 h6, .News_list .list dt span, .node .con .date_02, .node .con .clearfix, .node .con .clearfix a, .panel_6 dl span, .panel_6 h5 .fr, .sidebar .menuOne ul li a.disable, .panel_7 h6, #dtb td, aside ul.qa li dd, aside ul.stats_2 li h6, footer .counter{
	color:#9a9a9a;
}
...
/*Tabs_3
.Tabs_3, .Tabs_3 ul li{
	border-bottom:#cfd4d8 2px solid;
}
.Tabs_3 ul li{
	background:#5999c1;
	border-top:#5999c1 2px solid;
	border-left:#5999c1 2px solid;
	border-right:#5999c1 2px solid;
}
.Tabs_3 ul li.selected{
	background:#fff;
	border-bottom:#fff 2px solid;
	border-top:#2f71b4 2px solid;
	border-left:#cfd4d8 2px solid;
	border-right:#cfd4d8 2px solid;
}
.Tabs_3 ul li.selected a, .Tabs_3 ul li a:hover{
	color:#000;
}
.Tabs_3 ul li a{
	color:#fff;
...
.table_1 thead, .table_1 .tfoot td{
...
.table_1 .tit td.sort a i, .panel_3 .up a, .panel_3 .down a, .Tabs_3 .pre, .Tabs_3 .next, .zc .num, aside ul.stats_2 li{
...
.News_list dl, .stat_3 dl, .node .b_dash, .panel_6 .b_dash, .panel_4 .b_dash{
	border-bottom:#b6b6b6 1px dashed;
}
.News_list .list dt{
	background:url(images/icon_2.png) -4px -75px no-repeat;
...
.border_gary, .border_gary_mini, .panel_3 .con .xx img{
	border:#cecece 1px solid;
}
...
.panel_8 .block, .panel_8 .block_selected, .panel_8 .corner, .panel_8 .categories a{
...
.panel_8 .block_selected h1, .panel_8 .block:hover h1, .panel_8 .block_selected b, .panel_8 .block:hover b{
	color:#016fbb;
}
...
.News_list .list dd span,.News_list .list dd font ,.News_list .list dt a font, .News_list header span, .stat_3 dl dt, .stat_3 dl dd, .stat_3 dl li, .stat_3 dl li a, .stat_3 dl li span{
	display:inline;
}
.News_list .pager li{
	float:left;
...
.panel_6 .divH, .panel_6 .divF, .panel_6 .divT, .panel_6 ul.button li, .panel_6 li a.print, .panel_6 li a.tips, .panel_6 li a.ywbl, .panel_6 li a.imp, .panel_6 li a.exp, .panel_6 li a.jk, .f_window .close{
	background-repeat:no-repeat;
}
.panel_6 .divB{
        ...
        <div class="gray_bg">
        	<div class="gray_bg2">
            	<div class="w_bg">
                	<div class="Bottom">
                    	<div class="Top_fw">
                        	<h1 class="t_c" id="title1"><s:property value='tDocSend.typeTitle'/><br>发文稿纸</h1>
