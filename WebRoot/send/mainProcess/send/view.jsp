...
<head>
    ...
    <link href="<%=path %>/send/css/seal.css" rel="stylesheet">
                    ...
                    <div class="divB">
                        ...
                        <div class="con">
                            <ul class="button clearfix">
                                ...
                                <li>
                                    <a id="todo_print" class="print" href="javascript:void(0);"
                                       onclick="toPrintPage();">打印</a>
                                </li>
                                <s:if test="#request.taskId!=''">
                                    <li>
                                        <a id="todo_scan" class="jk"
                                           href="http://<%=ultimusIp%>/sLogin/workflow/TaskStatus.aspx?TaskID=<s:property value='#request.taskId'/>"
                                           target="_blank">监控</a>
                                    </li>
                                </s:if>
                                <!--
                ...
                <div class="Bottom">
                    <div class="Top_fw">
                        ...
                        <div class="mb10">
                            ...
                            <table id="form_detail_zone" width="100%" border="0" cellspacing="0" cellpadding="0"
                                   class="table_2">
                                <thead>
                                <th colspan="4" class="lableTd6"><h5><b style="display:inline">发文字号:</b></h5>
                                    <h5 style="display:inline;font-weight:normal;background-image:none;"><s:property
                                            value='tDocSend.sendId'/></h5>
                                    <h5 style="float:right;display:inline;background-image:none;">
                                        <b style="display:inline">文别：</b><span
                                            style="display:inline;font-weight:normal;"><s:property
                                            value='tDocSend.docClass'/></span>
                                        <b style="display:inline">&nbsp;&nbsp;&nbsp;&nbsp;密别：</b><span
                                            style="display:inline;font-weight:normal;"><s:property
                                            value='tDocSend.secretClass'/></span>
                                        <b style="display:inline">&nbsp;&nbsp;&nbsp;&nbsp;缓急：</b><span
                                            style="display:inline;font-weight:normal;"><s:property value='tDocSend.hj'/>&nbsp;&nbsp;</span>
                                    </h5>
                                </th>
                                </thead>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                <tr class="content6">
                                    ...
                                    <td colspan="3" class="content6">
                                        <s:property value='tDocSend.docTitle' escape="false"/>
                                        <input type="hidden" name="docTitle"
                                               value="<s:property value='tDocSend.docTitle'/>"/>
                                    </td>
                                </tr>
                                <tr class="content6">
                                ...
                                <s:if test="#request.print!=1">
                                    <tr class="content7">
                                        ...
                                        <td colspan="3">
                                            <!--  -->
                                            <input type="hidden" name="contentAtt" id="contentAttachmentId"
                                                   value="<s:property value="tDocSend.contentAtt"/>"/>
                                            ...
                                            <s:if test="#request.stepName=='核稿'||#request.stepName=='办结'||#request.stepName=='秘书'||#request.stepName=='领导'||#request.stepName=='签发秘书'||#request.stepName=='签发领导'">
                                                <iframe scrolling="auto" height="150" frameborder="0" marginheight="0"
                                                        marginwidth="0" width="100%" id="contentAttachmentFrame"
                                ...
                                <tr class="content7">
                                    <td style="width:50%;border-right:#000 1px solid;" colspan="2">
                                        印制份数：&nbsp;<s:property value='tDocSend.docCount'/>份
                                    </td>
                        ...
                        <div class="mb10 t_c">
                            ...
                            <div id="formUpdate_loading" style="width:100%;align:center;line-height:20px;display:none;"
                                 class="">
                                <p style="width:auto;display:inline;"><img src="<%=path %>/images/loading.gif"
