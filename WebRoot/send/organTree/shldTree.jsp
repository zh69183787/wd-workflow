...
<meta charset="utf-8" />
	...
	<script type="text/javascript">
		...
		var setting = {
			async: {
				enable: true,
				url:"<%=path %>/send-organTree/getShlds.action?type=1",
				autoParam:["id"],
...
<form>
	...
	<input id="tnodeName" type="text" readonly value="" style="width:72%;"/>
	<input id="nodeId" type="hidden" readonly value=""  />
	<input id="nodeDeptId" type="hidden" readonly value=""  />
	<input id="nodeLoginName" type="hidden" readonly value=""  />
	<input id="nodeMsName" type="hidden" readonly value="" />
	<input id="nodeMsDeptId" type="hidden" readonly value="" />
	<input id="nodeMsLoginName" type="hidden" readonly value="" />
