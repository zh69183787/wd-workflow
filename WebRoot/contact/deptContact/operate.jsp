...
<html>
	<head>
		...
		<title><s:property value="params.processParam['steplabel']"/></title>
		...
		<s:include value="../deptSubProcess/zone/js.jsp">
			<s:param name="steplabel" value="params.processParam['steplabel']"></s:param>
		</s:include>
	...
	<body class="Flow">
		<form action="" name="formOperate" id="formOperate" method="post">
			...
			<s:include value="../deptSubProcess/zone/handle.jsp">
				<s:param name="flowType" value="flowType"></s:param>
				<s:param name="deptId" value="#session.dept_id"></s:param>
			</s:include>
									...
									<div class="mb10">
										...
										<table id="form_detail_zone" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
											...
											<tr class="content6">
												...
												<td colspan=3 class="pl18"><s:property value="mainVo.mainUnit" />&nbsp;</td>
											</tr>

											<tr class="content6">
												<td class="lableTd t_r">抄送部门</td>
												<td colspan=3 class="pl18"><s:property value="mainVo.copyUnit" />&nbsp;</td>
											</tr>

											<tr class="content6">
												<td class="lableTd t_r">主题</td>
												<td colspan="3" class="content6"><s:property value="mainVo.theme" /></td>
											</tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
											<tr class="content7">
												...
												<td><s:property value="mainVo.contactDate"/></td>
