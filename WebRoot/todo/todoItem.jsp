...
<!--[if IE 6.0]>
           <script src="<%=path%>/receive/js/iepng.js" type="text/javascript"></script>
	...
	<style>
	body{font-family:Arial, "Helvetica Neue", "Microsoft YaHei", "Liberation Sans", FreeSans, sans-serif;}
		</style>
	<script type="text/javascript">
	 //跳转到制定页
...
<body>
	<div class="main">
		...
		<div class="ctrl clearfix">
			<div class="fl"><img id="show" onclick="showHide();" src="<%=path%>/receive/css/default/images/sideBar_arrow_right.jpg" width="46" height="30" alt="收起"></div>
            <div class="posi fl">
            	<ul>
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <a href="javascript:void(0);" class="todoUrl"><img src="<%=path%>/receive/css/default/images/p_open.gif"></a></td>
                                 <td class="t_c nwarp">
                                <input type="hidden" value="<s:property value='#items.taskid'/>" id="taskid"/>
                                <input type="hidden" value="<s:property value='#items.pname'/>" id="pname"/>
                                
                                <a href="javascript:void(0);" class="todoScan"><img src="<%=path%>/receive/css/default/images/p_but9.gif"></a></td>
                                </tr>
                                </s:iterator>
                              </tbody>
                              <tr class="tfoot">
