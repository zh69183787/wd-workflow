...
$(function(){
	...
	$("#handleSubmit").click(function(){
		if(confirm("确认提交吗？")){
			...
			options.url = "<%=path %>/project-discardMain/registerModify.action";
...
<div id="handle_zone" style="display:none;" title="<%=steplabel%>">
	...
	<div class="con">
		...
		<table id="choiceZone1" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr height="30">
				<td class="td_1">
					<input type="radio" checked="checked" name="choice" value="<%=DiscardMainConstants.CHOICE_MODIFY_SUBMIT_DEPT_LEADER%>"/>
				</td>
				<td width="93%">提交部门领导审核</td>
			</tr>
			...
			<tr height="30">
				<td class="td_1">
					<input type="radio" name="choice" value="<%=DiscardMainConstants.CHOICE_MODIFY_CANCEL%>"/>
				</td>
				<td>取消申报</td>
			</tr>
				<tr>
