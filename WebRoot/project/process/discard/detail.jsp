...
<%if(DiscardMainStepConstants.STEPNAME_DEPT_LEADER.equals(steplabel)){%>
	<s:include value="%{#request.getContextPath()}/project/process/discard/regLeader.jsp"></s:include>
<%}else if(DiscardMainStepConstants.STEPNAME_TH_RECV.equals(steplabel)){ %>
	<s:include value="%{#request.getContextPath()}/project/process/discard/preTrial.jsp"></s:include>	
<%}else if(DiscardMainStepConstants.STEPNAME_TH_OPERATOR.equals(steplabel)){ %>
	<s:include value="%{#request.getContextPath()}/project/process/discard/officer.jsp"></s:include>
<%}else if(DiscardMainStepConstants.STEPNAME_DEAL_FINISH.equals(steplabel)){ %>
	<s:include value="%{#request.getContextPath()}/project/process/discard/finish.jsp"></s:include>
<%}else if(DeptSubStepConstants.STEPNAME_DISPATCHER.equals(steplabel)){%>
	<s:include value="%{#request.getContextPath()}/project/process/dept/receiver.jsp"></s:include>
<%}else if(DeptSubStepConstants.STEPNAME_DEAL.equals(steplabel)){%>
	<s:include value="%{#request.getContextPath()}/project/process/dept/officer.jsp"></s:include>
<%}else if(DeptSubStepConstants.STEPNAME_LEADER.equals(steplabel)){%>
	<s:include value="%{#request.getContextPath()}/project/process/dept/leader.jsp"></s:include>	
<%} %>
									...
									<tr class="content6">
                                  	...
                                  	<tr class="content6">
                                  		<td colspan="4" width="100%">
											...
											<table id="assetTable" style="width:1200px;">
											<thead>
					                        <tr>
