...
<%--         <div class="tabs_2">
        ...
        <div class="filter">
            <div class="query p8">
            	<form action="<%=path %>/project-discardUtil/queryList.action" method="post" id="form">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="t_r">发起人</td>
                            <td>
                                <input type="text" value="<s:property value='operatorName'/>" name="operatorName" class="input_large" id="operatorName" />
                            </td>
                        	<td class="t_r">状态</td>
                            <td>
                ...
                <tbody>
                    ...
                    <s:iterator value="#request.page.result" var="item">
                        <tr name="data_tr">
                            ...
                            <td class="t_c"><s:property value="#item[6]==0?'进行中':'完成'"/></td>
                            <td class="t_c">
