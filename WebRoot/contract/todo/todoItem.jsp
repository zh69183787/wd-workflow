...
<%
	...
	if("logout".equals(type)){
		session.invalidate();
		String t = "http://10.1.14.20:7001/ca/login.jsp?appName=workflowtest%26returnUrl=http%3A%252F%252F10.1.41.252%3A8080%252Fworkflow%252Fcontract%252Ftodo%252FtodoItem.jsp";
...
<html>
  <head>
  	<script src="/workflow/contract/js/jquery-1.7.1.js"></script>
  ...
  <body>
	...
	<br/>
	<div>
	<input type="button" name="add" id="add" value="添加合同后神流程" onclick="window.open('http://10.1.41.252:8080/workflow/contract/process/review/add.jsp?yrtyrtyr')"/>
	</div>
	
	<br/>
	<div>
	<!--<a href="<%=path %>/test.jsp" target="_blank">test.jsp</a>-->
	<a href="<%=path %>/contract/process/review/list.jsp" target="_blank">查询列表（合同）</a>
	</div>
	<%} %>
  </body>
</html>
