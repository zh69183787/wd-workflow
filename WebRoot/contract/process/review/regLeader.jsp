...
$(function(){
	$("#handleSubmit").click(function(){
		if(confirm("确认提交吗？")){
			...
			options.url = "<%=path %>/contract-reviewMain/deptLeader.action";
...
<div id="handle_zone" style="display:none;" title="<%=steplabel%>">
	...
	<div class="con">
		...
		<table id="choiceZone1" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr height="30">
				<td class="td_1">
					<input type="radio" checked="checked" name="choice" value="<%=ReviewMainConstants.CHOICE_DEPT_LEADER_SUBMIT_CONTRACT%>"/>
				</td>
				<td width="93%">提交合约部初审</td>
			</tr>
			<tr height="30">
				<td class="td_1">
					<input type="radio" name="choice" value="<%=ReviewMainConstants.CHOICE_DEPT_LEADER_REGISTER_MODIFY%>"/>
				</td>
				<td>返回修改</td>
			</tr>
				<tr>
