...
$(function(){
	$("#handleSubmit").click(function(){
		if(confirm("确认提交吗？")){
			...
			options.url = "<%=path %>/contract-reviewMain/contractSimulate.action";
...
<div id="handle_zone" style="display:none;" title="<%=steplabel%>">
	...
	<div class="con">
		...
		<table id="choiceZone1" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr height="30">
				<td class="td_1">
					<input type="radio" checked="checked" name="choice" value="<%=ReviewMainConstants.CHOICE_SIMULATE_END_PROCESS%>"/>
				</td>
				<td width="93%">合同办结，结束流转</td>
			</tr>
			<tr height="30">
				<td class="td_1">
					<input type="radio" name="choice" value="<%=ReviewMainConstants.CHOICE_SIMULATE_CHOOSE_LEADER_DEPT%>"/>
				</td>
				<td width="93%">提交部门及集团领导会签</td>
			</tr>
			...
			<tr height="30">
				<td class="td_1">
					<input type="radio"  name="choice" value="<%=ReviewMainConstants.CHOICE_SIMULATE_BACK_MODIFY%>"/>
				</td>
				<td width="93%">退回申报人修改</td>
			</tr>
